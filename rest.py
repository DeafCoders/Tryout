...
class Copernica:
    ...
    def get_mailings(self, token):
        ...
        return self.curl_options("https://api.copernica.com/emailings/?" + urllib.urlencode(params))

    def get_mailing_details(self, token, emailing_id):
        params = {}
        params['access_token'] = token
        return self.curl_options("https://api.copernica.com/emailing/" + str(emailing_id) + '/statistics/?' + urllib.urlencode(params))
...
print(Copernica().get_mailing_statistics("5fad6ce4eeca28c7fbd41f16073dc2e4f67f823b925d40ea3fc6bd8eb313b5723fdc7a0af0d65a01c52fefeaa35beec951e3ff4fe905d0a12a1342f5b070a313", "19"))
